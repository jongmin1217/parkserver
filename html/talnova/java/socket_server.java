...
public class socket_server {
    ...
    void send_create_insert(String user) {
        
        try {
        	waitmap.get(user).writeUTF("create_insert");
        ...
        private void service() throws IOException {
            ...
            while (true) {
                ...
                if(str_list[0].equals("start")) {
                	...
                	System.out.println(waitmap);
                }else if(str_list[0].equals("create")) {
                	send_create_insert(str_list[1]);
                }else if(str_list[0].equals("insert")) {
                	send_create_insert(str_list[1]);
                }
                else {
    ...
    public static void main(String[] args) {
        socket_server s = new socket_server();
